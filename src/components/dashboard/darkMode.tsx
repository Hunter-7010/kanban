...
const DarkMode = () => {
  ...
  return (
    <>
      <div className="m-2 flex h-[48px] w-[235px] items-center justify-center space-x-5 rounded-lg bg-gray-100 dark:bg-gray-700">
        ...
        <label className="relative inline-flex cursor-pointer items-center">
          <input type="checkbox" checked={darkMode} className="peer sr-only" />
          <div
            onClick={switchMode}
