    ...
    <div className="flex grow flex-col overflow-y-auto">
      <div className="flex h-[96px] items-center justify-between border-b dark:border-gray-700 ">
        ...
        <div className="flex animate-pulse space-x-4 pr-10">
          <div className="group flex items-center justify-center rounded-3xl duration-300 dark:hover:bg-gray-700 hover:bg-gray-300">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32.055 32.055"
              fill="current"
              className="h-6 w-6 rotate-90 cursor-pointer p-1 duration-300 dark:fill-white dark:group-hover:fill-gray-200 group-hover:fill-gray-600"
            >
      ...
      <div className="flex h-full w-full flex-wrap overflow-y-auto">
        <div className="my-4 ml-16 h-[580px] w-[280px] space-y-6 overflow-y-auto rounded-lg">
          ...
          <div className="flex h-[121px] dark:bg-gray-700 animate-pulse items-center justify-center rounded-lg bg-white shadow-lg duration-500 hover:opacity-90 hover:shadow-sm"></div>
        </div>
        <div className="group my-12 ml-16 flex h-[550px] w-[280px] dark:from-gray-700 animate-pulse items-center justify-center rounded-lg bg-gradient-to-b from-gray-300 to-white">
